...
public:
    ...
    timer_(io_service), sequence_number_(0) {
...
private:
    ...
    void start_send() {
        ...
        vector<boost::uint32_t> body;
        body.push_back((uint32_t)12);           // Originate Timestamp
        body.push_back((uint32_t)0);            // Receive Timestamp
        body.push_back((uint32_t)0);            // Transmit Timestamp
